...
class NormalizedEnv(ProxyEnv, Serializable):
    def __init__(
        ...
        self._obs_mean = np.array(env.observation_space.zeros)#np.zeros(env.observation_space._dim)#.flat_dim
        self._obs_var = np.array(env.observation_space.ones)#np.ones(env.observation_space._dim)#.flat_dim
    ...
    def _update_obs_estimate(self, obs):
        flat_obs = np.array(obs)#self.wrapped_env.observation_space.flatten(obs)
